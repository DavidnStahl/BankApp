...
namespace BankApp.Migrations
{
    ...
    [Migration("20200515083019_mobileappusers")]
    partial class mobileappusers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankApp.Models.Cards", b =>
                {
            ...
            modelBuilder.Entity("BankApp.Models.Customers", b =>
                {
            ...
            modelBuilder.Entity("BankApp.Models.Dispositions", b =>
                {
                    b.Property<int>("DispositionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BankApp.Models.Loans", b =>
                {
            ...
            modelBuilder.Entity("ClassLibary.Models.BatchStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ClassLibrary.Models.MobileAppUsers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BankApp.Models.Cards", b =>
                {
                    b.HasOne("BankApp.Models.Dispositions", "Disposition")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("BankApp.Models.Dispositions", b =>
                {
                    b.HasOne("BankApp.Models.Accounts", "Account")
                        .WithMany("Dispositions")
                        .HasForeignKey("AccountId")
                        .HasConstraintName("FK_Dispositions_Accounts")
                        .IsRequired();

                    b.HasOne("BankApp.Models.Customers", "Customer")
                        .WithMany("Dispositions")
            ...
            modelBuilder.Entity("BankApp.Models.Transactions", b =>
                {
                    b.HasOne("BankApp.Models.Accounts", "AccountNavigation")
